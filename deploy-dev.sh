...
kubectl set image deployments/server-deployment server=sampriyadarshi/multi-server:$SHA --namespace development
kubectl set image deployments/client-deployment client=sampriyadarshi/multi-client:$SHA --namespace development
kubectl set image deployments/worker-deployment worker=sampriyadarshi/multi-worker:$SHA --namespace development
